			...
			<div class="col-md-7">
             <?php  
                if($aux){
				    ...
				    echo "<hr>";
				    echo "<br>";
				    echo "<form action='user-update2.php' method='post'>";
                    echo "<input type='text' name='codigo' value='$codigo' hidden>";
					echo "<span >Usuario:</span>";
					echo "<input class='form-control 'type='text' name='username' value='$username'>";
					echo "<br>";
					echo "<span >Contraseña:</span>";
					echo "<input class='form-control' type='text' name='pass' value='$pass'>";
					echo "<br>";
					echo "<span >Nombre:</span>";
					echo "<input class='form-control' type='text' name='name' value='$name'>";
					echo "<br>";
					echo "<span >Correo:</span>";
					echo "<input class='form-control' type='text' name='email' value='$email'>";
					echo "<br>";
					echo "<span >Numero Telefonico:</span>";
					echo "<input class='form-control' type='text' name='phone' value='$phone'>";
					echo "<br>";
					echo "<span >Direccion:</span>";
					echo "<textarea class='form-control' name='address' >$address</textarea>";
					echo "<br>";
					echo "<input type='submit' class='btn btn-primary text-right' value='Modificar'></input>";
				    echo "</form>";
                 }else{
