...
session_start();
    ...
    $query = "update user set username='$username', pass= '$pass', name= '$name', email= '$email', phone='$phone', address='$address' where id=$codigo;";
...
<head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1>Se Modifico el usuario correctamente</h1>
