...
session_start();	
	...
	$registros=mysqli_query($conexion,"insert into user (username,pass,name,email,address,phone) values ('$username','$pass','$name','$email','$address','$phone'); ") or
...
<head>
    ...
    <body>
        ...
        <div class="container">
			...
			<h1>Se creo el usuario correctamente</h1>
